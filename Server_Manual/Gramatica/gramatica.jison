...
FOR: for_ parAbre DECLARACION  EXPRESION pcoma EXPRESION parCierra BLOQUE_SENTENCIAS { $$ = new For($3, $4, $6,$8, this._$.first_line, this._$.first_column); }
	| for_ parAbre DECLARACION  EXPRESION pcoma INCRE_DECRE parCierra BLOQUE_SENTENCIAS { $$ = new For($3, $4, $6,$8, this._$.first_line, this._$.first_column); }
	;
...
EXPRESION : 
	...
	| EXPRESION igual EXPRESION		{ $$ = new OperacionRelacional( TypeOperation.IGUAL, $1, $3, this._$.first_line, this._$.first_column); }
