        ...
        while (n != this.texto.length - 1) {
            ...
            switch (this.char) {
                ...
                case "'":
                    ...
                    if (this.texto[n += 1] == "'") {
                        this.columna++;
                        this.lista_Token.push(new Token_1.Token(this.fila, this.columna, "caracter", "'" + this.char + "'"));
                    }
                    else {
                ...
                case '"':
                    ...
                    if (this.char == '"') {
                        this.lista_Token.push(new Token_1.Token(this.fila, this.columna, "cadena", '"' + this.cadena + '"'));
                        this.cadena = "";
                    }
                    break;
                case '/':
                ...
                default:
                    if (this.isLetter(this.char)) {
                        ...
                        if (this.dict[this.cadena] == undefined) {
                            this.lista_Token.push(new Token_1.Token(this.fila, this.columna, "identificador", this.cadena));
                            this.cadena = "";
                        }
                        else {
                            this.guardar();
                        ...
                        if (this.char == '.') {
                            if (this.isNumber(this.texto[n + 1])) {
                                ...
                                this.lista_Token.push(new Token_1.Token(this.fila, this.columna, "decimal", this.cadena));
                                this.cadena = "";
                            }
                        }
                        else {
                            this.lista_Token.push(new Token_1.Token(this.fila, this.columna, "entero", this.cadena));
                            this.cadena = "";
                        }
                    }
                    else {
...
//# sourceMappingURL=Lexico.js.map